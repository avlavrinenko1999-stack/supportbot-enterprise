...
def test_employee_service_has_no_direct_mapping_model() -> None:
...
def test_employee_service_uses_mapping_service() -> None:
    source = SERVICE_PATH.read_text(encoding="utf-8")
...
def test_employee_service_has_single_mapping_dependency() -> None:
    source = SERVICE_PATH.read_text(encoding="utf-8")
